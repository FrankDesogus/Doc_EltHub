...
# WhiteNoise serve /static/ direttamente dal processo Django — usato sul
# deploy Windows (waitress, niente nginx davanti). Su un deploy Linux con
# nginx è inerte: nginx intercetta /static/ prima che la richiesta arrivi
# a Django.
STORAGES = {
    'default': {
